...
| F4b | [x] | Security pass — evaluate findings + address open items (own session, after F4a) |
...
| F9 | [x] | Macro-level architecture review (own session — see session prompt below) |
