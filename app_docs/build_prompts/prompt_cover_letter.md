...
<!-- ============================================================
     HOW TO USE
     ──────────
     Load alongside: jobsearch.md + jobsearch_cover.md
                     + cover_letter_template.typ
     Output: Confirmed hook/tone/salutation → complete .typ cover letter
     CRITICAL: Do not write a single word of the letter until
     salutation, tone, and hook are confirmed by the user.

     This prompt contains no candidate-specific facts.
     All personal data, voice rules, reusable blocks, and candidate
     context live in jobsearch.md and jobsearch_cover.md — the sole
     sources of truth.
     ============================================================ -->
...
Company Website: [URL]
Hook Seed (optional): [ANY PERSONAL NOTE, ANGLE, OR SEED — or leave blank]
