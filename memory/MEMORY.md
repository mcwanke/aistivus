...
- [Test Baseline — FOLLOWUPS-C C4+C5 done](test_baseline_followups_c.md) — Frontend: 222/6 pre-existing; Backend: 577/0 (+6 new tests from C4+C5)
...
- [FOLLOWUPS-C C4+C5 Session](session_followups_c_c4_c5.md) — C4+C5 complete (ActivityLogRow layout rework + audit text in header); C6+C7 next
