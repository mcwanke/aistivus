...
- [User Profile](user_profile.md) — technical founder, non-technical friends as target users, locally-hosted tool
- [Deferred Work](deferred_work.md) — Python → api/ restructure, DB settings → config.yaml migration
- [My Data Architecture](my_data_architecture.md) — my_data/ folder, file-based .bak versioning, resume_templates/ subdir
- [Dead Config](dead_config.md) — min_score_threshold in config.yaml is unreferenced
- [Phase 1.2 Decisions](phase_1_2_decisions.md) — Profile Builder replaces Typst (now 1.3); key design choices for chat, streaming, versioning
...
- [Test Baseline — FOLLOWUPS-C C3 done](test_baseline_followups_c.md) — Frontend: 216/6 pre-existing; Backend: 577/0 (+11 new tests from C3)
...
- [FOLLOWUPS-C C2 Session](session_followups_c_c2.md) — C2 complete (file rename); C3 needs prompt text; C4+C5, C6+C7 next
- [FOLLOWUPS-C C3 Session](session_followups_c_c3.md) — C3 complete (Generate Resume + Cover Letter prompts); C4+C5, C6+C7 next
